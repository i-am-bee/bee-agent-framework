...
let _fmaas_DecodingParameters_ResponseFormat: {
  readonly TEXT: "TEXT";
  readonly JSON: "JSON";
};
...
let _fmaas_ModelInfoResponse_ModelKind: {
...
export declare interface ProtoGrpcType {
  fmaas: {
